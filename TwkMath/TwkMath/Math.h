...
//******************************************************************************
template <typename T, class P> inline const T& STD_MIN(const T& x, const T& y, P p)
{
    return (p(x, y) ? x : y);
}
...
//******************************************************************************
template <typename T, class P> inline const T& STD_MAX(const T& x, const T& y, P p)
{
    return (p(x, y) ? y : x);
}
...
//******************************************************************************
template <typename T> inline T Math<T>::pi()
{
    return (T)M_PI;
}

//******************************************************************************
template <typename T> inline T Math<T>::e()
{
    return (T)M_E;
}
...
//******************************************************************************
template <typename T> inline T Math<T>::sqr(const T& a)
{
    return a * a;
}
...
//******************************************************************************
template <> inline float Math<float>::mod(const float& numer, const float& denom)
{
    return ::fmod(numer, denom);
}

//******************************************************************************
template <> inline float Math<float>::pow(const float& body, const float& expon)
{
...
//******************************************************************************
template <> inline char Math<char>::ceil(const char& v)
{
    return v;
}

//******************************************************************************
template <> inline char Math<char>::floor(const char& v)
{
    return v;
}

//******************************************************************************
template <> inline char Math<char>::mod(const char& numer, const char& denom)
{
    return numer % denom;
}
...
//******************************************************************************
//******************************************************************************
template <> inline unsigned char Math<unsigned char>::abs(const unsigned char& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned char Math<unsigned char>::ceil(const unsigned char& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned char Math<unsigned char>::floor(const unsigned char& v)
{
    return v;
}
...
//******************************************************************************
template <> inline short Math<short>::ceil(const short& v)
{
    return v;
}

//******************************************************************************
template <> inline short Math<short>::floor(const short& v)
{
    return v;
}

//******************************************************************************
template <> inline short Math<short>::mod(const short& numer, const short& denom)
{
    return numer % denom;
}
...
//******************************************************************************
//******************************************************************************
template <> inline unsigned short Math<unsigned short>::abs(const unsigned short& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned short Math<unsigned short>::ceil(const unsigned short& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned short Math<unsigned short>::floor(const unsigned short& v)
{
    return v;
}
...
//******************************************************************************
template <> inline int Math<int>::ceil(const int& v)
{
    return v;
}

//******************************************************************************
template <> inline int Math<int>::floor(const int& v)
{
    return v;
}
...
//******************************************************************************
//******************************************************************************
template <> inline unsigned int Math<unsigned int>::abs(const unsigned int& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned int Math<unsigned int>::ceil(const unsigned int& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned int Math<unsigned int>::floor(const unsigned int& v)
{
    return v;
}
...
//******************************************************************************
template <>
inline unsigned int Math<unsigned int>::mod(const unsigned int& numer, const unsigned int& denom)
{
    return numer % denom;
}
...
//******************************************************************************
template <> inline long Math<long>::ceil(const long& v)
{
    return v;
}

//******************************************************************************
template <> inline long Math<long>::floor(const long& v)
{
    return v;
}

//******************************************************************************
template <> inline long Math<long>::mod(const long& numer, const long& denom)
{
    return numer % denom;
}
...
//******************************************************************************
//******************************************************************************
template <> inline unsigned long Math<unsigned long>::abs(const unsigned long& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned long Math<unsigned long>::ceil(const unsigned long& v)
{
    return v;
}

//******************************************************************************
template <> inline unsigned long Math<unsigned long>::floor(const unsigned long& v)
{
    return v;
}
...
//******************************************************************************
// char
template <> inline char Math<char>::min()
{
    return CHAR_MIN;
}

//******************************************************************************
template <> inline char Math<char>::max()
{
    return CHAR_MAX;
}

//******************************************************************************
template <> inline char Math<char>::epsilon()
{
    return 1;
}

//******************************************************************************
template <> inline bool Math<char>::isFloat()
{
    return false;
}
...
//******************************************************************************
// unsigned char
template <> inline unsigned char Math<unsigned char>::min()
{
    return 0;
}
...
//******************************************************************************
template <> inline bool Math<unsigned char>::isFloat()
{
    return false;
}
...
//******************************************************************************
// short
template <> inline short Math<short>::min()
{
    return SHRT_MIN;
}

//******************************************************************************
template <> inline short Math<short>::max()
{
    return SHRT_MAX;
}

//******************************************************************************
template <> inline short Math<short>::epsilon()
{
    return 1;
}

//******************************************************************************
template <> inline bool Math<short>::isFloat()
{
    return false;
}
...
//******************************************************************************
// unsigned short
template <> inline unsigned short Math<unsigned short>::min()
{
    return 0;
}
...
//******************************************************************************
template <> inline bool Math<unsigned short>::isFloat()
{
    return false;
}
...
//******************************************************************************
// int
template <> inline int Math<int>::min()
{
    return INT_MIN;
}

//******************************************************************************
template <> inline int Math<int>::max()
{
    return INT_MAX;
}

//******************************************************************************
template <> inline int Math<int>::epsilon()
{
    return 1;
}

//******************************************************************************
template <> inline bool Math<int>::isFloat()
{
    return false;
}
...
//******************************************************************************
// unsigned int
template <> inline unsigned int Math<unsigned int>::min()
{
    return 0;
}
...
//******************************************************************************
template <> inline unsigned int Math<unsigned int>::epsilon()
{
    return 1;
}

//******************************************************************************
template <> inline bool Math<unsigned int>::isFloat()
{
    return false;
}
...
//******************************************************************************
// long
template <> inline long Math<long>::min()
{
    return LONG_MIN;
}

//******************************************************************************
template <> inline long Math<long>::max()
{
    return LONG_MAX;
}

//******************************************************************************
template <> inline long Math<long>::epsilon()
{
    return 1;
}

//******************************************************************************
template <> inline bool Math<long>::isFloat()
{
    return false;
}
...
//******************************************************************************
// unsigned long
template <> inline unsigned long Math<unsigned long>::min()
{
    return 0;
}
...
//******************************************************************************
template <> inline bool Math<unsigned long>::isFloat()
{
    return false;
}
...
//******************************************************************************
// float
template <> inline float Math<float>::min()
{
    return -FLT_MAX;
}

//******************************************************************************
template <> inline float Math<float>::max()
{
    return FLT_MAX;
}

//******************************************************************************
template <> inline float Math<float>::epsilon()
{
    return FLT_EPSILON;
}

//******************************************************************************
template <> inline bool Math<float>::isFloat()
{
    return true;
}
...
//******************************************************************************
// double
template <> inline double Math<double>::min()
{
    return -DBL_MAX;
}

//******************************************************************************
template <> inline double Math<double>::max()
{
    return DBL_MAX;
}

//******************************************************************************
template <> inline double Math<double>::epsilon()
{
    return DBL_EPSILON;
}

//******************************************************************************
template <> inline bool Math<double>::isFloat()
{
    return true;
}
