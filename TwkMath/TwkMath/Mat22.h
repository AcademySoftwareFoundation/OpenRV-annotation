...
//******************************************************************************
template <typename T>
inline const T* Mat22<T>::operator[](typename Mat22<T>::size_type rowIndex) const
{
    assert(rowIndex < 2);
#ifdef COMPILER_GCC2
...
//******************************************************************************
template <typename T>
inline const T& Mat22<T>::operator()(typename Mat22<T>::size_type rowIndex,
...
//******************************************************************************
//******************************************************************************
template <typename T> inline typename Mat22<T>::size_type rowDimension(const Mat22<T>&)
{
    return 2;
}

//******************************************************************************
template <typename T> inline typename Mat22<T>::size_type colDimension(const Mat22<T>&)
{
    return 2;
}
...
//******************************************************************************
template <typename T> inline void transpose(Mat22<T>& m)
{
    m.transpose();
}
...
//******************************************************************************
template <typename T> inline void invert(Mat22<T>& m)
{
    m.invert();
}
...
template <typename T> inline Mat22<T> operator*(const Mat22<T>& a, const Mat22<T>& b)
{
    return Mat22<T>((a.m00 * b.m00) + (a.m01 * b.m10), (a.m00 * b.m01) + (a.m01 * b.m11),
