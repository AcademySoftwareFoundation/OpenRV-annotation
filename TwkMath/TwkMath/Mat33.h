...
template <typename T> class Mat33
{
  public:
    ...
    Mat33(const T& v00, const T& v01, const T& v02, const T& v10, const T& v11, const T& v12,
    ...
    void set(const T& v00, const T& v01, const T& v02, const T& v10, const T& v11, const T& v12,
             const T& v20, const T& v21, const T& v22)
    {
        m00 = v00;
        m01 = v01;
...
//******************************************************************************
template <typename T>
inline const T* Mat33<T>::operator[](typename Mat33<T>::size_type rowIndex) const
{
    assert(rowIndex < 3);
#ifdef COMPILER_GCC2
...
//******************************************************************************
template <typename T>
inline const T& Mat33<T>::operator()(typename Mat33<T>::size_type rowIndex,
...
//******************************************************************************
//******************************************************************************
template <typename T> inline typename Mat33<T>::size_type rowDimension(const Mat33<T>&)
{
    return 3;
}

//******************************************************************************
template <typename T> inline typename Mat33<T>::size_type colDimension(const Mat33<T>&)
{
    return 3;
}
...
//******************************************************************************
template <typename T> inline void transpose(Mat33<T>& m)
{
    m.transpose();
}
...
//******************************************************************************
template <typename T> inline void invert(Mat33<T>& m)
{
    m.invert();
}
...
//******************************************************************************
template <typename T> inline void makeTranslation(Mat33<T>& m, const Vec2<T>& t)
{
    m.makeTranslation(t);
}
...
//******************************************************************************
template <typename T> inline void setTranslation(Mat33<T>& m, const Vec2<T>& t)
{
    m.setTranslation(t);
}

//******************************************************************************
template <typename T> inline void addTranslation(Mat33<T>& m, const Vec2<T>& t)
{
    m.addTranslation(t);
}
...
//******************************************************************************
template <typename T> inline void makeRotation(Mat33<T>& m, const T& angleInRadians)
{
...
//******************************************************************************
template <typename T> inline Vec2<T> transform(const Mat33<T>& m, const Vec2<T>& v)
{
    return m.transform(v);
}

//******************************************************************************
template <typename T> inline Vec2<T> transformDir(const Mat33<T>& m, const Vec2<T>& v)
{
...
{
    return Mat33<T>(a.m00 * b, a.m01 * b, a.m02 * b, a.m10 * b, a.m11 * b, a.m12 * b, a.m20 * b,
                    a.m21 * b, a.m22 * b);
}
...
{
    return Mat33<T>(a * b.m00, a * b.m01, a * b.m02, a * b.m10, a * b.m11, a * b.m12, a * b.m20,
                    a * b.m21, a * b.m22);
}
...
template <typename T> bool zeroWithinTolerance(const Mat33<T>& M, T tolerance)
{
    if (Math<T>::abs(M.m00) > tolerance || Math<T>::abs(M.m01) > tolerance ||
        Math<T>::abs(M.m02) > tolerance || Math<T>::abs(M.m10) > tolerance ||
        Math<T>::abs(M.m11) > tolerance || Math<T>::abs(M.m12) > tolerance ||
        Math<T>::abs(M.m20) > tolerance || Math<T>::abs(M.m21) > tolerance ||
