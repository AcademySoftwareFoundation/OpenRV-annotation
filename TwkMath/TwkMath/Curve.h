...
inline VAL hermite(const VAL& vn1, const VAL& v0, const VAL& v1, const VAL& v2, const INTERP& t)
{
...
template <class VAL, class INTERP>
inline VAL hermiteBegin(const VAL& v0, const VAL& v1, const VAL& v2, const INTERP& t)
{
    static const INTERP i2 = (INTERP)2;
    static const INTERP i3 = (INTERP)3;
...
template <class VAL, class INTERP>
inline VAL hermiteEnd(const VAL& vn1, const VAL& v0, const VAL& v1, const INTERP& t)
{
    static const INTERP i2 = (INTERP)2;
    static const INTERP i3 = (INTERP)3;
...
template <class VAL, class INTERP> VAL hermite(const VAL* vals, int numVals, const INTERP& t)
{
    ...
    {
        return hermiteEnd(vals[numVals - 3], vals[numVals - 2], vals[numVals - 1],
                          t - (numVals - 2));
    }
    else
    {
...
template <class T>
Vec2<T> bezierCurve2D(const Vec2<T>& p0, const Vec2<T>& p1, const Vec2<T>& p2, const Vec2<T>& p3,
                      const T t)
{
...
template <class T>
Vec2<T> bezierSamplingTangent2D(const Vec2<T>& p0, const Vec2<T>& p1, const Vec2<T>& p2)
{
