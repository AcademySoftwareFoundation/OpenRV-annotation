...
// F = sum( ( zi - zMean )^2 )
template <typename T>
void eigenAnalysisOf3x3CovarianceMatrix(T A, T B, T C, T D, T E, T F, Vec3<T> vecs[], T vals[])
{
...
void principalComponentAnalysis3(ITER begin, ITER end, VEC& mean, VEC components[], TA vals[],
                                 TB dummy)
{
