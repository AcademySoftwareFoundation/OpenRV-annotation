...
//******************************************************************************
template <class VEC>
typename Box<VEC>::value_type Box<VEC>::size(typename Box<VEC>::size_type i) const
{
    if (min[i] > max[i])
    {
        // Empty
...
//******************************************************************************
template <class VEC>
inline typename Box<VEC>::value_type Box<VEC>::center(typename Box<VEC>::size_type i) const
{
    if ((min[i] > max[i]) ||
        (min[i] == Math<value_type>::min() && max[i] == Math<value_type>::max()))
    {
        return (value_type)0;
    }
    else
...
{
    return !(v[0] < min[0] || v[0] > max[0] || v[1] < min[1] || v[1] > max[1] || v[2] < min[2] ||
             v[2] > max[2]);
}

//******************************************************************************
template <class VEC>
bool Box<VEC>::intersects(const VEC& p, typename Box<VEC>::value_type radius) const
{
    //
...
//******************************************************************************
//******************************************************************************
template <class VEC> inline typename Box<VEC>::size_type dimension(const Box<VEC>& b)
{
    return VEC::dimension();
}

//******************************************************************************
template <class VEC> inline VEC size(const Box<VEC>& b)
{
    return b.size();
}
...
//******************************************************************************
template <class VEC>
inline typename Box<VEC>::value_type size(const Box<VEC>& b, typename Box<VEC>::size_type i)
{
    return b.size(i);
}
...
//******************************************************************************
template <class VEC>
inline typename Box<VEC>::value_type center(const Box<VEC>& b, typename Box<VEC>::size_type i)
{
    return b.center(i);
}
...
//******************************************************************************
template <class VEC> inline void makeEmpty(Box<VEC>& b)
{
    b.makeEmpty();
}
...
//******************************************************************************
template <class VEC> inline bool intersects(const Box<VEC>& b, const Box<VEC>& b2)
{
...
//******************************************************************************
template <class VEC>
inline Box<VEC> operator*(const typename Box<VEC>::value_type& a, const Box<VEC>& b)
{
    Box<VEC> c(b);
    return (c *= a);
}
...
//******************************************************************************
template <class VEC>
inline Box<VEC> operator*(const Box<VEC>& a, const typename Box<VEC>::value_type& b)
{
    Box<VEC> c(a);
    return (c *= b);
}
