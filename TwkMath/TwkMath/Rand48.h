...
template <> inline unsigned short Rand48Generator<unsigned short>::operator()()
{
...
//*****************************************************************************
inline float Rand48::nextFloat()
{
    return (float)nextDouble();
}

//*****************************************************************************
inline float Rand48::next()
{
    return nextFloat();
}

//*****************************************************************************
inline float Rand48::nextFloat(float range)
{
