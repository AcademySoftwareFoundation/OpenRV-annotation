...
template <typename T> inline typename Vec3<T>::const_iterator Vec3<T>::begin() const
{
...
template <typename T> inline typename Vec3<T>::const_iterator Vec3<T>::end() const
{
...
template <typename T> inline size_t dimension(Vec3<T>)
{
    return 3;
}
...
template <typename T, typename S> inline T dot(const Vec3<T>& a, const Vec3<S>& b)
{
