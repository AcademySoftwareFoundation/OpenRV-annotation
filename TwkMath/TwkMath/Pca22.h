...
// C = sum( ( yi - ymean )^2 )
template <typename T>
void eigenAnalysisOf2x2CovarianceMatrix(T A, T B, T C, Vec2<T> vecs[], T vals[])
{
...
void principalComponentAnalysis2(ITER begin, ITER end, VEC& mean, VEC components[], TA vals[],
                                 TB dummy)
{
