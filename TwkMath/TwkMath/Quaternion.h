...
template <typename T> class Quaternion
{
  public:
    ...
    Quaternion(const Vec3<T>& fromLook, const Vec3<T>& fromUp, const Vec3<T>& toLook,
               const Vec3<T>& toUp)
    {
    ...
    void setValue(const Vec3<T>& fromLook, const Vec3<T>& fromUp, const Vec3<T>& toLook,
                  const Vec3<T>& toUp);
...
//*****************************************************************************
template <typename T>
void Quaternion<T>::setValue(const Vec3<T>& rotateFrom, const Vec3<T>& rotateTo)
{
...
//*****************************************************************************
template <typename T> inline void Quaternion<T>::invert()
{
    conjugate();
}
...
//******************************************************************************
template <typename T>
inline bool areEquivalent(const Quaternion<T>& q1, const Quaternion<T>& q2, const T& tolerance)
{
    const T t = Math<T>::sqr(q1.x - q2.x) + Math<T>::sqr(q1.y - q2.y) + Math<T>::sqr(q1.z - q2.z) +
                Math<T>::sqr(q1.w - q2.w);
...
//******************************************************************************
template <typename T> inline Quaternion<T> normalized(const Quaternion<T>& q)
{
    return q.normalized();
}
...
//******************************************************************************
template <typename T> inline Quaternion<T> conjugated(const Quaternion<T>& q)
{
    return q.conjugated();
}

//******************************************************************************
template <typename T> inline void invert(Quaternion<T>& q)
{
    q.invert();
}
...
//******************************************************************************
template <typename T> inline void scaleAngle(Quaternion<T>& q, const T& angScale)
{
    q.scaleAngle(q);
}
...
//*****************************************************************************
template <typename T>
Quaternion<T> slerp(const Quaternion<T>& p, const Quaternion<T>& q, const T& alph)
{
    ...
    return Quaternion<T>((beta * p.x) + (alpha * q.x), (beta * p.y) + (alpha * q.y),
...
//*****************************************************************************
template <typename T>
void Quaternion<T>::setValue(const Vec3<T>& fromLook, const Vec3<T>& fromUp, const Vec3<T>& toLook,
                             const Vec3<T>& toUp)
{
