...
template <> inline unsigned int QuickRandGenerator<unsigned int>::operator()()
{
    return nextULong();
}
...
//*****************************************************************************
inline void QuickRand::reset(unsigned long seed)
{
    m_state = seed;
}
...
//*****************************************************************************
inline long QuickRand::nextLong()
{
...
//*****************************************************************************
template <class RANDGEN> inline float GaussRand<RANDGEN>::next(float mean, float stddev)
{
