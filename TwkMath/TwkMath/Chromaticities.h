...
template <class T> class Chromaticities
{
  public:
    ...
    Chromaticities(const Vec& r = Vec(0.0f), const Vec& g = Vec(0.0f), const Vec& b = Vec(0.0f),
                   const Vec& w = Vec(0.0f))
        : red(r)
        , green(g)
        , blue(b)
        , white(w)
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.640, 0.340), Vec2<T>(0.310, 0.595),
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.640, 0.330), Vec2<T>(0.290, 0.600),
    ...
    static Chromaticities<T> Rec2020()
    {
        ...
        return Chromaticities<T>(Vec2<T>(0.708f, 0.292f), Vec2<T>(0.170f, 0.797f),
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.680, 0.320), Vec2<T>(0.265, 0.690), Vec2<T>(0.150, 0.06),
                                 Vec2<T>(0.314, 0.315)); // ~6300K
    }
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.640, 0.330), Vec2<T>(0.210, 0.710), Vec2<T>(0.150, 0.06),
                                 Vec2<T>(0.3127, 0.3290));
    }

    static Chromaticities<T> SMPTE_C()
    {
        return Chromaticities<T>(Vec2<T>(0.630, 0.340), Vec2<T>(0.310, 0.595),
                                 Vec2<T>(0.155, 0.070), Vec2<T>(0.3127, 0.3290));
    }

    static Chromaticities<T> SMPTE_240M()
    {
        return Chromaticities<T>(Vec2<T>(0.67, 0.33), Vec2<T>(0.21, 0.71), Vec2<T>(0.15, 0.06),
                                 Vec2<T>(0.312713, 0.329016));
    }

    static Chromaticities<T> ACES()
    {
        return Chromaticities<T>(Vec2<T>(0.73470, 0.26530), Vec2<T>(0.00000, 1.00000),
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.690, 0.300), Vec2<T>(0.205, 0.715),
    ...
    {
        return Chromaticities<T>(Vec2<T>(0.6840, 0.3130), Vec2<T>(0.2210, 0.8480),
    ...
    static Chromaticities<T> RedColor()
    {
        return Chromaticities<T>(
            Vec2<T>(0.699747001291, 0.329046930313), Vec2<T>(0.304264039024, 0.623641145129),
    ...
    {
        return Chromaticities<T>(
            Vec2<T>(0.878682510476, 0.32496400741), Vec2<T>(0.300888714367, 0.679054755791),
    ...
    {
        return Chromaticities<T>(
            Vec2<T>(0.701181035906, 0.329014155583), Vec2<T>(0.300600304652, 0.683788834269),
    ...
    {
        return Chromaticities<T>(
            Vec2<T>(0.701180591892, 0.329013699116), Vec2<T>(0.300600395529, 0.683788824257),
    ...
    {
        return Chromaticities<T>(
            Vec2<T>(0.753044222785, 0.327830576682), Vec2<T>(0.299570228481, 0.700699321956),
    ...
    {
        return Chromaticities<T>(
            Vec2<T>(0.753044491143, 0.327831029513), Vec2<T>(0.299570490451, 0.700699415614),
